  ...
  head: () => ({
    meta: [
      ...
      { title: "ALPAZA — Made for the Move" },
      {
        name: "description",
        content:
          "ALPAZA is a minimal luxury clothing brand designed for movement. Online cart launching soon — order now via Instagram or WhatsApp.",
      },
      { name: "theme-color", content: "#111111" },
      { property: "og:site_name", content: "ALPAZA" },
      { property: "og:title", content: "ALPAZA — Made for the Move" },
      {
      ...
      { name: "twitter:title", content: "ALPAZA — Made for the Move" },
      {
