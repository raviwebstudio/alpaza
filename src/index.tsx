...
const WHATSAPP_URL = "https://wa.me/919259880496?text=Hi%20ALPAZA%2C%20I%27d%20like%20to%20place%20an%20order.";
  ...
  return (
    ...
    >
      <div className="mx-auto grid max-w-7xl grid-cols-[auto_1fr_auto] items-center gap-6 px-4 py-4 sm:px-6 lg:px-10">
        <a href="#top" className="font-display text-xl tracking-[0.35em] sm:text-2xl">
          ALPAZA
        </a>
        ...
        <div className="relative">
          <div className="relative aspect-[4/5] w-full overflow-hidden rounded-sm bg-stone-warm">
            ...
            <div className="absolute inset-x-6 bottom-6 flex items-end justify-between text-primary-foreground">
              <div>
                <p className="eyebrow !text-primary-foreground/70">Chapter 01</p>
...
function Marquee() {
  const words = ["Made for the Move", "Coming Soon", "Minimal Luxury", "Est. Alpaza"];
      ...
      <div className="marquee-track flex w-max items-center gap-14 whitespace-nowrap">
        {line.map((w, i) => (
          <span key={i} className="flex items-center gap-14">
            <span className="font-display text-2xl italic text-foreground/80 sm:text-3xl">{w}</span>
...
function Collection() {
  const items = [
    { img: tee1, name: "Essential Oversized Tee", tag: "Essentials", note: "Signature weight cotton" },
    { img: tee2, name: "Signature Heavyweight Tee", tag: "Heavyweight", note: "240 GSM combed cotton" },
    { img: tee3, name: "Classic Oversized Tee", tag: "Classic", note: "Premium combed cotton" },
    { img: tee4, name: "Everyday Oversized Tee", tag: "Everyday", note: "Soft-hand jersey knit" },
  ];
  const reveal = useReveal();

  return (
    <section id="collection" className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-10 lg:py-32">
      <div className="mb-12 flex flex-wrap items-end justify-between gap-6">
        <div>
          ...
          <h2 className="font-display text-4xl leading-tight sm:text-5xl lg:text-6xl">
            The first pieces,<br />
            <span className="italic text-muted-foreground">quietly considered.</span>
          </h2>
        </div>
      ...
      <div ref={reveal.ref} className={`${reveal.className} grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4`}>
        {items.map((it, i) => (
          <article
            key={it.name}
          ...
          >
            ...
            <div className="p-5">
              <p className="eyebrow">{it.tag} · N°{String(i + 1).padStart(2, "0")}</p>
      ...
      >
        <div>
          ...
          <h2 className="font-display text-4xl leading-[1.05] sm:text-5xl lg:text-6xl">
            A quiet study in <span className="italic">motion</span> and material.
          </h2>
        </div>
        <div className="space-y-6 text-base leading-relaxed text-muted-foreground sm:text-lg">
          ...
          <p>
            Every piece is prototyped on real bodies, worn through real days, and
            revised until nothing pulls, bunches, or restricts. The result is a
            uniform for the way you actually live.
          </p>
...
function WhyUs() {
  const items = [
    { icon: Leaf, t: "Responsibly Sourced", d: "Small-batch mills, traceable fibres, low-impact dyes." },
    { icon: Ruler, t: "Engineered Fit", d: "Patterns refined across dozens of wear tests." },
    { icon: ShieldCheck, t: "Built to Last", d: "Reinforced seams and finishes designed for years." },
    { icon: Truck, t: "Direct to You", d: "No middlemen. Fair pricing, no seasonal markdowns." },
  ];
  const reveal = useReveal();
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-10 lg:py-32">
      ...
      <div ref={reveal.ref} className={`${reveal.className} grid grid-cols-1 gap-px overflow-hidden rounded-sm bg-border sm:grid-cols-2 lg:grid-cols-4`}>
        {items.map(({ icon: Icon, t, d }) => (
          <div key={t} className="group bg-background p-8 transition-colors duration-500 hover:bg-foreground hover:text-background">
            ...
            <p className="mt-3 text-sm text-muted-foreground transition-colors group-hover:text-background/70">{d}</p>
          </div>
        ))}
      </div>
    </section>
    ...
    <section id="fabric" className="bg-ink text-primary-foreground">
      ...
      >
        ...
        <div className="order-1 flex flex-col justify-center lg:order-2">
          <p className="eyebrow mb-4 !text-primary-foreground/60">Quality & Fabric</p>
          <h2 className="font-display text-4xl leading-tight sm:text-5xl lg:text-6xl">
            Fabric first.<br />
          ...
          <ul className="mt-10 grid gap-4">
            {[
              ...
              <li key={line} className="flex items-start gap-4 border-t border-primary-foreground/15 pt-4 text-sm">
...
function Testimonials() {
  const reveal = useReveal();
  const items = [
    { quote: "Premium quality and perfect oversized fit. Exactly what I wanted.", name: "Ankur" },
    { quote: "The fabric feels amazing and the print quality is excellent.", name: "Nishant" },
    { quote: "Minimal design with premium packaging. Worth every rupee.", name: "Shivam" },
    { quote: "Finally an Indian oversized tee brand that feels truly premium.", name: "Priyanshu" },
  ];
  return (
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-10">
        ...
        >
          {items.map((t) => (
            ...
            >
              <div>
                <div className="flex items-center gap-1" aria-label="5 out of 5 stars" style={{ color: "#F5C542" }}>
...
function Faq() {
  const items = [
    ...
    },
    {
      ...
      a: "Unworn pieces can be returned within 14 days of delivery. We cover return shipping on any size exchange.",
    },
    {
  ...
  return (
    <section id="faq" className="mx-auto max-w-4xl px-4 py-24 sm:px-6 lg:px-10 lg:py-32">
      <div className="mb-12 text-center">
        <p className="eyebrow mb-3">FAQ</p>
        <h2 className="font-display text-4xl leading-tight sm:text-5xl lg:text-6xl">
          Everything, <span className="italic text-muted-foreground">answered.</span>
        </h2>
      </div>
  ...
  return (
    <section className="bg-secondary py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-10">
        ...
        <div ref={reveal.ref} className={`${reveal.className} grid grid-cols-2 gap-2 sm:grid-cols-3 sm:gap-3 lg:grid-cols-6`}>
          {tiles.map((src, i) => (
            <a
              key={i}
              href={INSTAGRAM_URL}
...
function Contact() {
  const reveal = useReveal();
  return (
    <section id="contact" className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-10 lg:py-32">
      <div
        ref={reveal.ref}
      ...
      >
        <div>
          ...
          <h2 className="font-display text-5xl leading-[1.02] sm:text-6xl lg:text-7xl">
            Let's talk.<br />
            <span className="italic text-muted-foreground">We reply personally.</span>
          </h2>
          <p className="mt-6 max-w-md text-base leading-relaxed text-muted-foreground">
            For orders, sizing help, press, or wholesale — reach us on the
            channels below. A real member of the studio responds within 24 hours.
          </p>
        </div>
    ...
    >
      <div className="flex min-w-0 items-center gap-4">
        ...
        <div className="min-w-0">
          <p className="eyebrow transition-colors group-hover:!text-background/60">{label}</p>
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1.5fr_1fr_1fr_1fr]">
          <div>
            ...
            <p className="mt-4 max-w-xs text-sm text-muted-foreground">
              Made for the Move. Minimal luxury essentials designed to move
              with you — launching online soon.
            </p>
          ...
          <FooterCol title="Explore" links={[["Collection", "#collection"], ["About", "#about"], ["Fabric", "#fabric"]]} />
          <FooterCol title="Support" links={[["FAQ", "#faq"], ["Contact", "#contact"], ["Shipping", "#faq"]]} />
          <FooterCol
            title="Order"
            links={[
